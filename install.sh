...
line='status_line = ["current-dir", "project-root", "model-name", "model-with-reasoning", "codex-version", "git-branch", "context-used", "context-remaining", "context-window-size", "used-tokens", "total-input-tokens", "total-output-tokens", "five-hour-limit", "weekly-limit", "session-id"]'
...
printf 'Installed %s\nRestart Codex once, then run: codex-hud --tmux\n' "$BIN/codex-hud"
